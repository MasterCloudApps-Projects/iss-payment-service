...
public class OutPaymentEntity extends AccountingEntryEntity {

	public OutPaymentEntity() {
        // to avoid deserialization exception
    }
    
    private OutPaymentEntity(final Builder builder) {
        setId(builder.id);
    ...
    public boolean equals(Object o) {
        ...
        if (!(o instanceof OutPaymentEntity)) return false;

        OutPaymentEntity that = (OutPaymentEntity) o;
    ...
    public static final class Builder {
        ...
        public OutPaymentEntity build() {
            return new OutPaymentEntity(this);
        }
    }
}
