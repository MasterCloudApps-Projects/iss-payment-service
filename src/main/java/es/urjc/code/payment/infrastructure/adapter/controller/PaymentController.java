...
public class PaymentController {
	...
	public ResponseEntity<PolicyAccountBalanceDto> accountBalance(@Parameter(description = "Account number. Cannot be empty.", required = true) @Valid @PathVariable("accountNumber") @NotEmpty String accountNumber) {
