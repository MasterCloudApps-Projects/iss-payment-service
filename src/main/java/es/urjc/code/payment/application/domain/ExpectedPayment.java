...
public class ExpectedPayment extends AccountingEntry {
    ...
    private ExpectedPayment(final Builder builder) {
        setId(builder.id);
    ...
    public boolean equals(Object o) {
        ...
        if (!(o instanceof ExpectedPayment)) return false;

        ExpectedPayment that = (ExpectedPayment) o;
    ...
    public static final class Builder {
        ...
        public ExpectedPayment build() {
            return new ExpectedPayment(this);
        }
    }	
